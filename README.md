...
- 메뉴
    - [ ]  메뉴의 등록.
        ...
        - [ ] 메뉴 가격은 0원 이상.
        - [ ] 메뉴는 메뉴 그룹을 설정해줘야 한다.
        - [ ] 메뉴 생성 시, 존재하는 상품이어야 함.
        - [ ] 메뉴의 상품들의 수량은 0개 이상.
        - [ ] 메뉴의 가격은 포함된 총합(상품 가격 X 수량) 보다 높을 수 없다.
...
- 상품
    ...
    - [ ]  상품 가격 수정하기.
        - [ ] 변경 가격은 0원 이상.
        - [ ] 가격 변경 후, 메뉴 가격의 가격이 총 합(상품 * 개수) 높다면 메뉴 비활성화
    - [ ]  상품 전부 가져오기.
## 용어 사전
